...
APPENDIX_SHEET = "附录"
DICT_SHEET = "征信合表"
INPUT_MODE = "java"  # 可选 "excel" 或 "java"
HEADER_CLASS_POLICY = {
    "ParameterMapping": "bodies",
    "Utils": "signatures",
}
...
# 头文件（供 prompt 参考）
HEADER_FILES = [
    "headers/ParameterMapping.java",
    # "headers/PbcReportCodeMapping.java",
    "headers/Utils.java",
]

# 头文件在 prompt 中的总字符上限（防止超长占满上下文）
MAX_HEADER_CHARS = 12000
HEADER_MINIFY_MODE = "signatures"
